...
/** Staff Manager service entry
 *  functions and security permission: 
 *             1.customer preference/feedback statistic			   (officer, expert)
 *             2.arrange for reservation                    (officer, expert, senior, assistant)
 ...
 *
 */
public class StaffManager implements User{

	StaffDTO staff;
	TaskService ts;
	
	public StaffManager(StaffDTO staff) {
		this.staff = staff;
	...
	public void startService() {
		...
		String[] funcs_all = {
				"customer preference/feedback statistic   (officer, expert)",
				"arrange for reservation                  (officer, expert, senior, assistant)",
