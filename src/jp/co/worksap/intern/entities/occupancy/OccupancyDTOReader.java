...
public class OccupancyDTOReader extends AbstractDTOReader<OccupancyDTO> {
	 ...
	 * @throws IOException
	 */
	public OccupancyDTOReader() throws IOException {
		super(OccupancyDTOReader.class.getName());
		super.init();
	}
	 ...
	 * @throws IOException
	 */
	public OccupancyDTOReader(final String fileAddress) throws IOException {
		super(OccupancyDTOReader.class.getName());
	...
	@Override
	protected OccupancyDTO convertArrayToDTO(String[] value) throws IOException {
		...
		OccupancyDTO dto = new OccupancyDTO(occupancyId , roomId , roomType , customerId , customerSource , price , priceUnit , checkInTime , checkOutTime);
		return dto;
	}
}
